...
#    We build features based on past behaviour of the portfolio:
#    - Lagged returns (1, 2, 5 days)
#    - Rolling volatility (5, 20 days)
#    - Rolling historical VaR (95%, 100-day window)
...
# Gradient Boosting as a proxy for XGBoost (safer, no extra dependency)
...
# If xgboost is installed, we use it too
try:
